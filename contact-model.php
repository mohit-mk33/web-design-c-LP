...
if(isset($_REQUEST['btn-submit'])){
    echo '<script>window.open("https://www.tgcindia.com/images/stories/brochure/webdesign.pdf", "_blank");</script>';
}
?>
<style>
...
$toaddress='tgcanimation@gmail.com,info@tgcindia.com';
$subject1='Inquiry from TGC New Landing Web Design';
...
// header('Location: https://tgcindia.com/thanks');
 echo '<script>window.open("https://tgcindia.com/thanks", "_blank");</script>';
?>
